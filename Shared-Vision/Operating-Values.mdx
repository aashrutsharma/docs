...
<CardGroup cols={2}>
  ...
  <Card title="Meet the Founders" icon="users" href="/founders/overview">
    Learn about Aashrut and Unnati's journeys
  </Card>
  
  <Card title="Explore Our Vision" icon="telescope" href="/vision-mission">
    See where Superadmission is headed
  </Card>
  
  <Card title="Join Our Mission" icon="handshake" href="/implementation/get-involved">
